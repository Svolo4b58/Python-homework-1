...
# трех цифр равна сумме последних трех. Т.е. билет с номером 385916 – счастливый, т.к. 3+8+5=9+1+6. Вам требуется 
...
# j = i // 1000; b = j % 10; k = j // 100; a = j % 100 // 10
# c = i % 1000; v = c % 10; n = c // 100; m = c % 100 // 10
# if (b + k + a == v + n + m):
